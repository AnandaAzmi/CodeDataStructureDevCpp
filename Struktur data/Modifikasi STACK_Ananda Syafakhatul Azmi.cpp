...
void Push (string d, int e) //fungsi untukk memasukan data ke dalam stack
{
    tumpuk.top++; //setiap ada data masuk, maka posisi top akan bertambah 1
    tumpuk.data [tumpuk.top]= d; //menyimpan data dalam stack
    tumpuk.kode[tumpuk.top]=e; //modifikasi
}

void pop ()// fungsi untuk menghapus data dalam stack
{
    cout << "Elemen terahir stack sudah dihapus, yaitu : "<< endl;
    cout<<"Nama : "<<tumpuk.data [tumpuk.top]<<endl;
    cout <<"Kode Unik   : "<<tumpuk.kode[tumpuk.top]<<endl; //modifikasi
...
void tampilstack ()//fungsi untuk menampilakn data yang ada dalam stack
{
    ...
    {
        cout <<endl;
        cout <<"Nama        : "<< tumpuk.data [i]<<endl; //tampilkan data yang ada dalam stack
        cout <<"Kode Unik   : "<< tumpuk.kode [i]<<endl;//modifikasi
        cout << endl;
    }
}
